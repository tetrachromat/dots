...
magenta: ag dmenu dunst dwm dwmblocks emacs hosts htop nvim picom st zsh # ag dmenu dunst dwm dwmblocks emacs hosts htop nvim picom st zsh
lite: vim zsh-lite
...
pam:
	...
	@stow -R pam 2>&1 | grep -v $(STOW_BUG) || :
...
.PHONY: ag chunkwm dmenu dunst dwm dwmblocks emacs firefox hosts htop nvim pam picom scripts st vim yabai zsh
