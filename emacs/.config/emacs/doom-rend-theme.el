;;; doom-rend-theme.el --- a dark (mostly) monochromatic theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Author: phat_sumo
;;; Commentary:
;;; Code:
...
(defgroup doom-rend-theme nil
  "Options for the `rend' theme."
  :group 'doom-themes)

(defcustom doom-rend-hl-line t
  "If non-nil, highlight the current line with an underline."
  :group 'doom-rend-theme
  :type 'boolean)

(defcustom doom-rend-uniform-font-size nil
...
(def-doom-theme doom-rend
  "A dark theme with bright highlights."

  ;;     default   256       16
  ((bg '("#030303"    "#030303"  "#030303"))
   (fg '("#fbf5f3" "#fbf5f3" "white"))

   (bg-alt '("#030303"   "#030303"   "#030303"))
   (fg-alt '("#fbf5f3" "#fbf5f3" "white"))

   (base0 '("#030303"   "#030303"   "#030303"))
   ...
   (base8 '("#fbf5f3" "#fbf5f3" "white"))

   (grey base4)
   (red       '("#fe3198" "#fe3198" "red"))
   (dark-red  '("#fe3198" "#fe3198" "red"))
   (orange    '("#fe3198" "#fe3198" "brightred"))
   (green     '("#00fbc3" "#00fbc3" "green"))
   (teal      '("#00fbc3" "#00fbc3" "brightgreen"))
   (yellow    '("#f5dc22" "#f5dc22" "yellow"))
   (blue      '("#262cda" "#262cda" "brightblue"))
   (dark-blue '("#262cda" "#262cda" "blue"))
   (magenta   '("#731dd8" "#731dd8" "brightmagenta"))
   (violet    '("#731dd8" "#731dd8" "magenta"))
   (cyan      '("#00d0ff" "#00d0ff" "brightcyan"))
   (dark-cyan '("#00d0ff" "#00d0ff" "cyan"))
   (white     '("#fbf5f3" "#fbf5f3" "white"))
  ...
  (((cursor &override) :background base7)
   ...
   (hl-line :underline doom-rend-hl-line)
   ...
   (doom-modeline-evil-normal-state :foreground white)
   ...
   (org-document-title :height (if doom-rend-uniform-font-size 1.0 1.7)
                       :foreground (if doom-rend-uniform-font-size base8 doc-comments)
   ...
   ;;;; outline
   (outline-1 :height (if doom-rend-uniform-font-size 1.0 1.5)
              :background base1 :weight 'bold)
   (outline-2 :height (if doom-rend-uniform-font-size 1.0 1.4)
              :foreground (if doom-rend-uniform-font-size (doom-darken fg 0.2))
              :background base1 :weight 'bold)
   (outline-3 :height (if doom-rend-uniform-font-size 1.0 1.3)
              :foreground (if doom-rend-uniform-font-size (doom-darken fg 0.3))
              :background base1 :weight 'bold)
   (outline-4 :height (if doom-rend-uniform-font-size 1.0 1.2)
              :foreground (if doom-rend-uniform-font-size (doom-darken fg 0.4))
              :background base1 :weight 'bold)
   (outline-5 :height (if doom-rend-uniform-font-size 1.0 1.1)
              :background base1
              :weight (if doom-rend-uniform-font-size 'normal 'bold))
   (outline-6 :height (if doom-rend-uniform-font-size 1.0 1.0)
              :foreground (if doom-rend-uniform-font-size (doom-darken fg 0.2))
              :background base1
              :weight (if doom-rend-uniform-font-size 'normal 'bold))
   (outline-7 :height (if doom-rend-uniform-font-size 1.0 1.0)
              :foreground (if doom-rend-uniform-font-size (doom-darken fg 0.3))
              :background base1 :weight 'normal)
   (outline-8 :height (if doom-rend-uniform-font-size 1.0 1.0)
              :foreground (if doom-rend-uniform-font-size (doom-darken fg 0.4))
   ...
   (rainbow-delimiters-depth-7-face :inherit 'rainbow-delimiters-depth-4-face)
